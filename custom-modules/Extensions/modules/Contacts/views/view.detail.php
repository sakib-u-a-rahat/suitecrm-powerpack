    ...
    public function display()
    {
        ...
        if (!empty($this->bean->id)) {
            ...
            <div class=\"leadjourney-buttons\">
                <a href=\"index.php?module=LeadJourney&action=timeline&parent_type=Contacts&parent_id=" . $recordId . "\">View Journey Timeline</a>
                <a href=\"index.php?module=LeadJourney&action=recordings&parent_type=Contacts&parent_id=" . $recordId . "\" class=\"secondary\">View Call Recordings</a>
            </div>";
        }
    }
}
